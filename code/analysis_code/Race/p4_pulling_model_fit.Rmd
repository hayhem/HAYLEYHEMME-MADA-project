...
car_black <- spautolm(`Death Cases` ~ `Percent Living in Poverty` + 
                        `Percent High School Education` + offset(Population),
...
car_multiple <- spautolm(`Death Cases` ~ `Percent Living in Poverty` + 
                        `Percent High School Education` + offset(Population),
                         data = multiple,
...
car_hispanic <- spautolm(`Death Cases` ~ `Percent Living in Poverty` + 
                        `Percent High School Education` + offset(Population),
                         data = hispanic,
...
car_white <- spautolm(`Death Cases` ~ `Percent Living in Poverty` + 
                        `Percent High School Education` + offset(Population),
                      data = white,
