...
```{r}
pca_function("Black")
ggsave(here("results/pca_black.png"), units="in", width=10, height=7, dpi=300)
```

```{r}
pca_function("Hispanic")
ggsave(here("results/pca_hispanic.png"), units="in", width=10, height=7, dpi=300)
```

```{r}
pca_function("Multiple")
ggsave(here("results/pca_multiple.png"), units="in", width=10, height=7, dpi=300)
```

```{r}
pca_function("White")
ggsave(here("results/pca_white.png"), units="in", width=10, height=7, dpi=300)
```
