...
ggplot(df_sf_scale, aes(long, lat)) +
  ...
  theme(strip.text = element_text(size = 14),
        legend.position = "bottom") +
  labs(title = "Map of Predicted Over Observed Black-to-White HIV-Related Mortality Rate Ratio,
United States, 2020 (GLM)", x = "", y = "", fill = "Ratio") +
  theme(plot.title= element_text(hjust = 0.5))
ggsave(here("results/mult_pred_map.png"), units="in", width=7, height=4, dpi=300)
...
United States, 2020 (CAR)", x = "", y = "", fill = "Ratio") +
  theme(plot.title= element_text(hjust = 0.5))
ggsave(here("results/car_pred_map.png"), units="in", width=7, height=4, dpi=300)
``` 
