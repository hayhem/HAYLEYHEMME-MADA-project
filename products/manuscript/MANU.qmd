...
![Histogram of the distribution of the ratio for observed/ expected cases(raw)](images/raw_roe_hist.png){width="300"}

![Histogram of the distribution of ratio of observed/ expected mortality after Box-Cox transformation](images/box_hist-01.png){width="300"}

![Diagnostics for Box Cox Transformed Ratio Observed/ Expected](images/box_diag.png){width="300"}*Use a combination of text/tables/figures to explore and describe your data. Show the most important descriptive results here. Additional ones should go in the supplement. Even more can be in the R and Quarto files that are part of your project.*

## Basic statistical analysis

|                                                     |                                                     |
|-----------------------|------------------------|
| ![Black](images/moran_black-01.png){width="200"}    | ![Multiple](images/moran_multiple.png){width="200"} |
| ![Hispanic](images/moran_hispanic.png){width="200"} | ![White](images/moran_white.png){width="200"}       |
...
|                                              |                                         |
|-----------------------------|------------------------------|
| ![](images/raw_rate_map-02.png){width="250"} | ![](images/roe_map-03.png){width="250"} |
| ![](images/roe_box_map-01.png){width="250"}  | ![](images/chi_map-02.png){width="250"} |
| ![](images/fitted_map-02.png){width="250"}   |                                         |
