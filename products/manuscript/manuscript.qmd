...
Since the emergence of the HIV epidemic in 1981 in the United States, more than 1.2 million people in the United States have been diagnosed with HIV, resulting in more than 700,000 HIV-related deaths \cite{jun07HIVAIDSEpidemic2021}. Medical advancements have led to effective antiretroviral therapies that not only treat HIV infection and reduce adverse HIV-related health outcomes, such as progression to AIDS, but have also led to use of these medications to prevent infection before and after potential exposure for people who are HIV negative Even still, more than 30,000 people in the United States continue to be diagnosed each year \cite{jun07HIVAIDSEpidemic2021}. While the Ending the Epidemic initiative set up a goal of 90% reduction in new HIV infections by 2030 by upscaling efforts in HIV diagnoses treatment, and prevention, this is followed by nearly one decade of steady HIV diagnoses rates. Developing targeted intervention programs is essential to achieve this goal. To accomplish this, we need to gain a deeper understanding of the impact or contribution of complex factors such as social determinants of health or other barriers to poor HIV-related outcomes and disparities.
...
|                                          |                                            |                                                 |
|----------------------|-----------------------|---------------------------|
| ![](images/gini_map-02.png){width="200"} | ![](images/uninsured_map.png){width="200"} | ![](images/no_internet_map-01.png){width="200"} |
...
![](images/car_fit_map-01.png){fig-align="center" width="600"}

![](images/mult_fit_map.png){width="600"}

|                                              |                                               |
|----------------------------------------------|-----------------------------------------------|
| ![](images/car_pred_map-03.png){width="350"} | ![](images/mult_pred_map-02.png){width="350"} |
