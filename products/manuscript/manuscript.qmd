...
Univariate analysis of HIV-related death rate

![](images/MRR_hist.png){fig-align="center"}

![](images/dr_state.png){fig-align="center"}

![](images/table1.png){fig-align="center"}

The distribution of death rate was assessed for each race both visually and using the Shapiro test for normality. Based on the Shapiro test, there was insufficient evidence to reject normality with a p-value of 0.63. No normalizing transformation was needed. Below is the histogram of the our primary outcome variable, MRR.
...
|                                    |                                 |
|------------------------------------|---------------------------------|
| ![](images/bi_pov-03.png)          | ![](images/bi_gini-04.png)      |
| ![](images/bi_unemployed-02.png)   | ![](images/bi_uninsured-01.png) |
| ![](images/bi_foodinsecure-01.png) |                                 |

*To get some further insight into your data, if reasonable you could compute simple statistics (e.g. simple models with 1 predictor) to look for associations between your outcome(s) and each individual predictor variable. Though note that unless you pre-specified the outcome and main exposure, any "p\<0.05 means statistical significance" interpretation is not valid.*

## Full analysis

![](images/corr_mat-01.png){fig-align="center"}

![](images/contriution_plot.png){fig-align="center"}
